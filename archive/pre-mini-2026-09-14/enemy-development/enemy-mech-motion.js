...
(() => {
  ...
  const paths={
    big:{walk:[[18,-5,0],[12,-5,0],[6,-5,0],[0,-5,0],[-6,-5,0],[-12,-5,0],[-18,-5,0],[-15,-12,.8],[-8,-15,.5],[2,-16,0],[10,-12,-.2],[16,-8,-.25]],run:[[18,-5,0],[12,-5,0],[3,-5,0],[-7,-13,1],[-16,-21,1.2],[-14,-32,.85],[-7,-33,.45],[0,-24,.05],[8,-17,-.3],[17,-11,-.35],[20,-8,-.3],[19,-7,-.25]],walkBob:[0,1,0,-2,-1,0,0,1,0,-2,-1,0],runBob:[0,3,1,-1,-3,-2,0,3,1,-1,-3,-2],jumpNear:[[-4,-11,.65],[9,-20,-.1],[12,-25,-.25],[14,-16,-.2],[15,-5,0],[10,-5,0]],jumpFar:[[-11,-9,.3],[-14,-12,.8],[-15,-18,1],[-12,-13,.65],[-10,-5,0],[-10,-5,0]],jumpBob:[0,-2,-3,0,8,2]},
  ...
  function sample(size,state='idle',frame=0){
    const family=size==='mini'?'mini':'big',small=family==='mini',d=dimensions[family],p=paths[family],action=state==='run-fire'?'run':state,f=loop(frame,(timings[state]||timings.idle).length);
