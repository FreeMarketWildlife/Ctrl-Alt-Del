...
(() => {
  'use strict';
  const dimensions={
    big:{hipY:-48,thigh:23,shin:23,spread:2,sole:5,hair:{root:[-7,-89],links:[7,8,8,7],widths:[2.5,4,3.5,2.5,.4]}},
  ...
  const loops=Object.fromEntries(Object.keys(timings).map(state=>[state,['stand','idle','walk','run','run-fire'].includes(state)]));
  ...
  const paths={
    big:{
      ...
      walkBob:[0,1,0,-2,-1,0,0,1,0,-2,-1,0],runBob:[0,3,1,-1,-3,-2,0,3,1,-1,-3,-2],
      ...
      'front-kick':[[16,-5,0],[5,-21,.5],[21,-37,-.65],[43,-41,-.85],[42,-40,-.85],[20,-32,.2],[14,-13,.2],[16,-5,0]],
      'round-kick':[[16,-5,0],[-5,-20,.9],[19,-42,-.2],[42,-54,.25],[39,-43,.4],[14,-32,.7],[8,-12,.2],[16,-5,0]],
      kickBob:[0,2,1,0,1,2,1,0],
      frontLean:[0,-2,-4,-5,-4,-2,0,0],roundLean:[0,-2,-3,-4,-2,1,1,0]
    },
    mini:{
