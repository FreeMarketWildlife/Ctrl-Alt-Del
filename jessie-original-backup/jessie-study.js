(() => {
  const canvas=document.getElementById('comparison'),ctx=canvas.getContext('2d'),shoot=document.getElementById('shoot'),silhouette=document.getElementById('silhouette');let base='run',time=0,last=performance.now(),paused=false,facing=1,key='';
