...
Choose [Big](recyke.html?size=big) or [Small](recyke.html?size=mini), then Jessie or
Jane. The level is linked from Episodes, Concept Art and the character/enemy workshops.
...
position and health. Changing size or selecting Restart begins a fresh route.
...
| Property | Big | Small |
| --- | --- | --- |
| Native scene | 640 × 360 | 480 × 270 |
| Hero / ground enemy cell | 128 × 128 | 48 × 48 |
| Standard standing height | 96px | 32px |
| Feet anchor in cell | (64,112) | (20,40) |
| Route width | 3,900 world pixels | 2,112 world pixels |
| Ground level | 308px | 222px |
| Clear entrance height | 112px | 40px |

Every source pixel is one world unit. Both routes have their own platform positions,
prop dimensions, movement speeds and jump physics. The complete scene is presented
...
Each route contains eight enemies drawn from all six approved archetypes. Machines
