...
(() => {
  'use strict';
  const entries=[
    {id:'sentinel',name:'Sentinel',group:'Mechs',role:'Patrol unit',description:'A narrow NEXUS patrol chassis with a single optic, articulated pistons and a forward cannon.',spanLabel:'96px / 32px standing height'},
    {id:'bastion',name:'Bastion',group:'Mechs',role:'Armored enforcer',description:'Broad plated armor, a riot shield and a shoulder rack. A heavy silhouette with deliberate attack preparation.',spanLabel:'96px / 32px standing height'},
    {id:'scrapper',name:'Scrapper',group:'Mechs',role:'Industrial hunter',description:'Reclaimed rusted armor, exposed machinery and a powered salvage claw from the lower city.',spanLabel:'96px / 32px standing height'},
    {id:'watcher',name:'Watcher',group:'Drones',role:'Surveillance drone',description:'An open twin-rotor truss, a magenta tracking optic and an underslung pulse cannon.',spanLabel:'96px / 32px neutral rotor span'},
    {id:'manta',name:'Manta',group:'Drones',role:'Aerial interceptor',description:'A swept armored wing, paired induction vents and a suspended forward emitter.',spanLabel:'96px / 32px neutral wing span'},
    {id:'collector',name:'Collector',group:'Drones',role:'Recovery drone',description:'A copper industrial hull, amber sensor and two articulated retrieval claws.',spanLabel:'96px / 32px neutral rotor span'}
  ];
  const specs={big:{width:128,height:128,anchor:[64,112]},mini:{width:48,height:48,anchor:[20,40]}};
  const columns=12;
