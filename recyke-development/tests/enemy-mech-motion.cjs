...
console.log(`Enemy mech motion: ${poses} native poses in the mini family; fixed bones, planted contacts, 12-pose locomotion, firing parity and articulated wreck pass. Max bone error ${maxError.toFixed(3)}px.`);
